...
public class BluetoothUtils {
    ...
    public static BluetoothDevice getPairedDeviceByName(final String deviceName)
            throws it.unibo.garden.bt.BluetoothDeviceNotFound {

        final Set<BluetoothDevice> pairedList = BluetoothAdapter.getDefaultAdapter()
                .getBondedDevices();
        ...
        throw new it.unibo.garden.bt.BluetoothDeviceNotFound();
    }

    public static BluetoothDevice getPairedDeviceByAddress(final String deviceMacAddress) throws it.unibo.garden.bt.BluetoothDeviceNotFound {
        final Set<BluetoothDevice> pairedList = BluetoothAdapter.getDefaultAdapter()
                .getBondedDevices();
